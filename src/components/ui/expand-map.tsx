...
export function LocationMap({
    ...
    return (
        ...
        >
            <motion.div
                className="relative overflow-hidden rounded-2xl bg-black/60 backdrop-blur-md border border-white/20 shadow-2xl"
                style={{
            ...
            >
                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            ...
                            />
                            <motion.div
                                className="absolute top-[15%] left-[35%] w-[12%] h-[15%] rounded-sm bg-white/10 border border-white/5"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                            ...
                            />
                            <motion.div
                                className="absolute top-[8%] left-[75%] w-[14%] h-[10%] rounded-sm bg-white/5 border border-white/5"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-5">
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        {/* Status indicator */}
                        <motion.div
                            className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-white/5 backdrop-blur-sm shadow-sm"
                            animate={{
                        ...
                        >
                            ...
                            <span className="text-[10px] font-medium text-white/70 tracking-wide uppercase">Open</span>
                        </motion.div>
                    </div>
            ...
            {/* Click hint */}
            <motion.p
                className="absolute -bottom-6 left-1/2 text-[10px] text-white/50 whitespace-nowrap"
                style={{ x: "-50%" }}
                initial={{ opacity: 0 }}
                animate={{
