...
export const PremiumButton: React.FC<ButtonProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* Overlay glow */}
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-400/20 via-blue-300/10 to-blue-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

            {/* Content */}
            <div className="relative z-10 flex items-center gap-4">
                {/* Icon */}
                <div className="p-3 rounded-lg bg-gradient-to-br from-blue-500/50 to-blue-400/30 backdrop-blur-sm group-hover:from-blue-400/60 group-hover:to-blue-500/40 transition-all duration-300">
